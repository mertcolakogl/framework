...
![Unity](https://img.shields.io/badge/unity-6000.3%2B-black?logo=unity&logoColor=white)
![Version](https://img.shields.io/badge/version-1.0.0-blue)
![Package](https://img.shields.io/badge/package-com.gambit.framework-informational)
...
Requires Unity **6000.3** or later (developed against `6000.3.24f1`, per `package.json`).
